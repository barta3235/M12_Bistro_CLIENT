...
const Navbar = () => {
    ...
    const navOptions = <>
        ...
        {
            user && isAdmin &&  <li className="flex items-center justify-center"><Link to='/dashboard/adminHome'>Admin Dashboard</Link></li>
        }
        {
            user && !isAdmin &&  <li className="flex items-center justify-center"><Link to='/dashboard/userHome'>User Dashboard</Link></li>
        }
        <li>
